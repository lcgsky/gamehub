...
export default function NewestGamesPage() {
      ...
      try {
        ...
        setTimeout(() => {
          ...
          const sortedGames = [...mockGames].sort((a, b) => {
            const dateA = new Date(gameReleaseDate[a.id as keyof typeof gameReleaseDate] || '2000-01-01');
            const dateB = new Date(gameReleaseDate[b.id as keyof typeof gameReleaseDate] || '2000-01-01');
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">最新游戏</h1>
        <p className="text-gray-600 max-w-3xl">
          发现最新上线的游戏。这些游戏根据发布日期排序，让你第一时间体验全新的游戏内容。
        </p>
      </div>
