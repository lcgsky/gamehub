...
import { mockGames, gamePopularity } from '@/data/mockData';
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-4">
          {translate(translations, 'pages.popular.title')}
        </h1>
        <p className="text-gray-600 max-w-3xl">
          {translate(translations, 'pages.popular.description')}
        </p>
      </div>
      ...
      <div className="mb-8">
        <div className="flex flex-wrap gap-3">
          ...
          >
            {translate(translations, 'pages.popular.all')}
          </button>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16">
          <h3 className="text-xl font-medium text-gray-800 mb-2">
            {translate(translations, 'pages.popular.noGames')}
          </h3>
          <p className="text-gray-600 mb-6">
            {translate(translations, 'pages.popular.tryOther')}
          </p>
          <button
            onClick={() => setFilterCategory(null)}
            className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition duration-150"
          >
            {translate(translations, 'pages.popular.viewAll')}
          </button>
        </div>
      )}
    </div>
